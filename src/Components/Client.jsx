        ...
        <div>
            <div className='row'>
                <div className='mt-5 mb-4 '>
                    ...
                    <h3 id='tt'><AiOutlineUsergroupAdd style={style} /> Clients</h3>
                    <Button variant='primary ' className='button1' onClick={() => handlePostShow()}> Add new Client
                    </Button>
                    <i ><AiOutlineSearch id='II' /></i>  <input placeholder="Enter Name. . . . ." id='input' onChange={event => setQuery(event.target.value)} />
